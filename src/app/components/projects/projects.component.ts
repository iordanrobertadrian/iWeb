...
export class ProjectsComponent implements OnInit {
  ...
  projects: Project[] = [
    ...
    },
    {
      ...
      description:
        'YuriShop va ofera spre vânzare, produse noi si resigilate. Compania noastra importa produsele din Germania, calitatea produselor fiind garantata de Tüv si piata germana.',
      badge: 'Magazin Online',
    },
    {
