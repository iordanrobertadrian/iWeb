...
export class AppComponent  implements OnInit{
  ...
  ngOnInit() {
    this.metaTagService.addTags([
      ...
      { name: 'description', content: 'Servicii profesionale in ceea ce priveste crearea de magazine online si site-uri web pentru prezentarea afacerii dumneavoastra.' },
      { charset: 'UTF-8' }
    ]);
